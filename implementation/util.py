class Parser:
   ...
   def parse_single_label(data_path, file_path1, file_path2, results_path):
      if file_path1 not in ["/ABSA16_Laptops_Train_SB1_v2.xml", "/ABSA16_Restaurants_Train_SB1_v2.xml"] or file_path2 not in ["/ABSA16_Laptops_Train_SB1_v2.xml", "/ABSA16_Restaurants_Train_SB1_v2.xml"]:
    ...
    def load_multi_label(path_to_text, path_to_labels):
       ...
       with open(path_to_labels) as f_labels:
          for line in f_labels:
             ...
             for attribute in attributes:
                if attribute.strip():
                   attrib_in_line.append(attribute)
             labels.append(attrib_in_line)
       return text, labels
